...
export const DISCOVERIES = [
  {
    ...
    facts: [
      'Chanteur pop rock anglais au ton positif, signé chez le label D.A Red Wolf Records, également connu comme remixeur pour des artistes comme OneRepublic et Lara Fabian.',
      'Son titre "Close To Me" a été diffusé sur plus d’une centaine de radios en France, en Belgique et en Suisse.',
      'Ses clips sont diffusés sur des chaînes comme C Star, Clubbing TV et Bblack Africa — mais il n’existe quasiment aucune biographie complète à son sujet en français.',
    ],
    portrait: "Tom York cultive un pop rock anglais au mood résolument positif, entre ballades et titres plus entraînants. Au-delà de sa carrière de chanteur, il est aussi remixeur pour d'autres artistes, dont OneRepublic et Lara Fabian, et ses clips circulent sur des chaînes musicales comme C Star, Clubbing TV et Bblack Africa. Son titre \"Close To Me\" a été diffusé sur plus d'une centaine de radios en France, en Belgique et en Suisse. Signé chez le label D.A Red Wolf Records, il a enchaîné les sorties en 2025 : \"Close To Me\" en mars, \"Sunscreen\" en juillet, puis \"I Can't Stay\" (feat. Noize). Repéré tôt par Radio Odyssey, il fait partie de ces découvertes qui ont trouvé leur public : plus d'un an après son arrivée sur l'antenne, il y est toujours régulièrement diffusé. Autre particularité : en ligne, très peu de sources s'intéressent à lui en dehors des plateformes de streaming — et son nom se confond facilement avec celui de Thom Yorke, le chanteur de Radiohead, qui est un artiste entièrement différent.",
