...
export const NAV_CATEGORIES = [
  ...
  },
  {
    ...
    pages: [
      ...
      { href: '/quiz-noms-artistes-radio-odyssey.html', bi: 'info-circle', label: "Quiz : d'où viennent leurs noms ?", desc: "L'origine des noms de scène des artistes de l'antenne" },
      { href: '/quiz-records-radio-odyssey.html', bi: 'trophy', label: 'Quiz : records et premières fois', desc: 'Classements, Grammy, Eurovision — des réponses qui ne bougeront plus' },
      { href: '/quiz-coulisses-artistes-radio-odyssey.html', bi: 'mic-fill', label: 'Quiz : les coulisses des titres', desc: "Qui chante vraiment, qui a écrit pour qui, pourquoi ce morceau existe" },
  ...
  },
  {
    ...
    pages: [
      ...
      { href: '/heart-coherence-breathing-at-work.html', bi: 'briefcase', label: 'Heart Coherence Breathing at Work', desc: 'Bring it into your workday, no app required' },
      { href: '/radio-odyssey-vs-meditation-apps.html', bi: 'peace', label: 'Radio Odyssey vs. Meditation Apps', desc: 'A no-pressure way to unwind' },
      { href: '/why-positive-radio-is-trending.html', bi: 'stars', label: 'Why Positive Radio Is Trending', desc: 'Doomscrolling fatigue and playlist burnout, explained' },
