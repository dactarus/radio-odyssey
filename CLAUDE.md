...
*Dernière mise à jour de ce fichier : 2026-08-16 (§82).*
...
11. **Décision internationale** — tranchée au §81 : ni traduction intégrale des 255 pages, ni repli, mais une **sélection assumée de portes d'entrée anglophones** pour un public froid. Lot 1 fait (§81 : les 13 pages sous `/en/`, 301, `hreflang` corrigé), lot 2 fait (§82 : accueil `/en.html`, interface bilingue, 4 pages traduites dont celle d'Elisabeth Bélot-Grimaud) ; lots 3 à 5 détaillés en fin de §82
