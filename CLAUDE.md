...
*Dernière mise à jour de ce fichier : 2026-08-16 (§77).*
...
12. **Poursuivre l'audit de l'appli** (§77) — lots 1 et 2 faits : ouverture hors ligne, curseur de volume, titre en cours dès l'ouverture, relevé calé sur la fin du morceau, palier de reconnexion, instrumentation complète. La suite est listée à la fin du §77, par ordre d'effet décroissant ; le premier point est de **porter les mêmes correctifs au lecteur du site**. ⚠️ Ne pas ajouter d'écran ni d'onglet à l'appli : ce qui fait les 16 minutes, c'est qu'il n'y a rien à parcourir.
